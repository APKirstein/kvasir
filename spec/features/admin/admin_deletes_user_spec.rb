...
feature 'admin deletes user', %{
  ...
  # Acceptance Criteria:
  # [ ] I must be logged in as an admin; if I am not, I receive an error and
  # then redirected to the home page
  # [ ] I can delete a user by visiting admin/users and clicking on a delete
  ...
  scenario 'admin deletes users' do
    ...
    expect(page).to have_content("Successfully deleted #{user.email}!")
